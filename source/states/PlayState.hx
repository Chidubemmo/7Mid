...
class PlayState extends MusicBeatState
{
	...
	public var DAD2_X:Float;
	public var DAD2_Y:Float;
	...
	override public function create()
	{
		...
		add(gfGroup);
		add(dadGroup);
		if (SONG.player4 != null || SONG.player4 != '')
		{
			add(dadGroup2);
		}
		add(boyfriendGroup);
	...
	function startSong():Void
	{
		...
		DiscordClient.changePresence(detailsText, SONG.song + " (" + storyDifficultyText + ") - By " + SONG.artistName, iconP2.getCharacter(), true,
			songLength);
		#end
	...
	override public function onFocusLost():Void
	{
		#if desktop
		if (health > 0 && !paused)
			DiscordClient.changePresence(detailsPausedText, SONG.song + " (" + storyDifficultyText + ") - By " + SONG.artistName, iconP2.getCharacter());
		#end
	...
	function resetRPC(?cond:Bool = false)
	{
		...
		if (cond)
			DiscordClient.changePresence(detailsText, SONG.song
				...
				+ storyDifficultyText
				+ " - By "
				+ SONG.artistName, iconP2.getCharacter(), true,
				songLength
